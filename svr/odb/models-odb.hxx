...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::Session >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::Session >
  {
    public:
    typedef ::Session object_type;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::Session, id_mysql, A >
  {
    // id
    //
    typedef
    ...
    static const member_id_type_ member_id;
    ...
    static const remote_ip_type_ remote_ip;
    ...
    static const remote_port_type_ remote_port;
  };

  template <typename A>
  const typename query_columns< ::Session, id_mysql, A >::id_type_
  query_columns< ::Session, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::Session, id_mysql, A >::member_id_type_
  query_columns< ::Session, id_mysql, A >::
  member_id (A::table_name, "`member_id`", 0);

  template <typename A>
  const typename query_columns< ::Session, id_mysql, A >::remote_ip_type_
  query_columns< ::Session, id_mysql, A >::
  remote_ip (A::table_name, "`remote_ip`", 0);

  template <typename A>
  const typename query_columns< ::Session, id_mysql, A >::remote_port_type_
  query_columns< ::Session, id_mysql, A >::
  remote_port (A::table_name, "`remote_port`", 0);

  template <typename A>
  struct pointer_query_columns< ::Session, id_mysql, A >:
    query_columns< ::Session, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::Session, id_mysql >:
    public access::object_traits< ::Session >
  {
    public:
    struct id_image_type
    {
    ...
    struct image_type
    {
      ...
      // _member_id
      //
      unsigned long long _member_id_value;
      my_bool _member_id_null;

      // _remote_ip
      //
      details::buffer _remote_ip_value;
      unsigned long _remote_ip_size;
      my_bool _remote_ip_null;

      // _remote_port
      //
      unsigned short _remote_port_value;
      my_bool _remote_port_null;
  ...
  template <>
  class access::object_traits_impl< ::Session, id_common >:
    public access::object_traits_impl< ::Session, id_mysql >
  {
  };
